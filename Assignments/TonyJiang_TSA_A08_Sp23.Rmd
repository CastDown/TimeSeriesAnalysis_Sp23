...
for_full_2010 <- seasonalpart_2010[(rowno+1):rowno1] + inflow_for$mean

# get the observed values of year 2010
original_inflow_2010 <- ts_inflow_full[(rowno+1):rowno1] %>% 
  ts(start = c(2010,1), frequency = 12)

# plot the forecast series and observaed series
for_full_2010 %>% 
  autoplot() + 
...
autoplot(for_full_2010) +
  autolayer(inflow_for_original$mean, series = "one step forecast", CI = FALSE) +
  autolayer(for_full_2010, series = "deseason + seasonality", CI = FALSE) +
  autolayer(original_inflow_2010, series = "true series") +
...
autoplot(ts_inflow_full) +
  ...
  autolayer(inflow_for_original, series = "one step forecast", PI = FALSE) +
  autolayer(expo_smooth, series = "exponential smooth forecast", PI = FALSE) +
  ylab("Inflow Data till 2010") +
