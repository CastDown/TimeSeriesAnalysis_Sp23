...
# retrieve the last column to have a full dataset, including year 2010 and 
ts_inflow_full <- inflow[, colno-1] %>% 
>>>>>>> bd5c639bf0cb29fc3ee4dea3e714104b1fc01a2b
...
=======
ts_inflow_2009_deseas <- stl(ts_inflow_2009, s.window = "periodic")

str(ts_inflow_2009_deseas$time.series)
plot(ts_inflow_2009_deseas$time.series[,2])
