...
```{r}
col_names = c("Total Biomass Energy Production", "Total Renewable Energy Production", "Hydroelectric Power Consumption")
...
fig$series <- NULL 
fig$lag[1:40] <- c(1:40)
fig %>% plot(main = paste("Autocorrelation of ", a[i]), xlab = "Lag(month)")
}
```
...
fig1 %>% plot(, main = paste("Partial Autocorrelation of ", a[i]), xlab = "Lags(month)")
}
```
