...
> Answer: 
ACF - ACF of MA(1) should have a cutoff at lag 1, which means ACF at lag 1 should be statistically significant (above the blue dashed line in pacf polt). And PACF at lag 2 and beyond should be statistically insignificant.
